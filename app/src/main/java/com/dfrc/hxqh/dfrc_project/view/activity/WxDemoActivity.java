...
import com.dfrc.hxqh.dfrc_project.view.widght.GlideImageLoader;
...
public class WxDemoActivity extends BaseActivity implements ImagePickerAdapter.OnRecyclerViewItemClickListener {
    ...
    ImageButton submitBtn;//提交按钮

    @Bind(R.id.picker_btn)
    Button chooseImageBtn;//选择图片
...
//                break;
    ...
    void setChooseImageBtnOnClickListener() {
        //打开选择,本次允许选择的数量
        ImagePicker.getInstance().setSelectLimit(maxImgCount - selImageList.size());
                            ...
                            new AsyncTask<String, String, String>() {
                                ...
                                protected String doInBackground(String... strings) {
                                    String reviseresult = AndroidClientService.connectWebService(WxDemoActivity.this,
                                            finalname, finalUpdataInfo, ownertable, ownerid, Constants.MOBILESERVICEURL);
                                    return reviseresult;
                                }
